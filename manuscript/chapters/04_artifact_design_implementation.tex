...
policy. This isolates the comparison: if the timing model or trace
sampler differed across conditions, any performance difference could not
be attributed to the agent decision layer. Table~\ref{tab:conditions}
