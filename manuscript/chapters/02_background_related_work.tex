...
This evaluation perspective is central to the present study. A generated
log is not useful merely because simulated agents produce plausible
explanations. It must also resemble held-out behavior across
control-flow, temporal, and resource dimensions. Chapela-Campa et al.'s
framework is therefore used as the main guardrail against overclaiming
the value of LLM-style agents.
...
future process-aware agents act autonomously, their behavior must remain
...
case inter-arrival sampling. Evaluation is therefore part of the
artifact design cycle, not only a final scorecard.
